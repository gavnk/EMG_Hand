...
# 2 "<built-in>" 2
# 1 "moving_avg_filter.c" 2
# 40 "moving_avg_filter.c"
# 1 "./signal_buffer.h" 1
# 46 "./signal_buffer.h"
...
# 42 "moving_avg_filter.c" 2
# 54 "moving_avg_filter.c"
_Bool madata_isfull(void)
{
    if ((ma_front == ma_rear + 1) || (ma_front == 0 && ma_rear == 26 - 1))
        return 1;
    else
        return 0;
}
